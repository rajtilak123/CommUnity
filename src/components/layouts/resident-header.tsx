...
export function ResidentHeader({ profile }: ResidentHeaderProps) {
  ...
  return (
    <header className="fixed top-0 z-50 flex h-16 w-full items-center justify-between border-b border-outline-variant bg-surface-container-lowest px-margin-mobile transition-colors md:w-[calc(100%-280px)] md:px-lg">
      ...
      <button
        type="button"
        className="flex size-10 items-center justify-center rounded-full text-on-surface-variant transition-colors hover:bg-surface-variant active:scale-95"
